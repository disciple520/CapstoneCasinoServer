...
public class DealerPanel extends JPanel {
		...
		private static final long serialVersionUID = 1L; // line added by Eclipse to resolve warning
		private Hand hand;
        private int minBet;
        ...
        public void flipSecond () {
                hand.getCardAtIndex(1).flip();
                repaint();
        }
        
        public boolean checkAce () {
                return hand.getCardAtIndex(0).getRank() == Card.ACE;
        }
        ...
        public void paintComponent(Graphics g) {
                ...
                for (int i = 0; i < hand.getSizeOfHand(); i++) {
                        drawCard(g, hand.getCardAtIndex(i), 10, 80 + 33*i);
                }
        }
